...
\headerbox{Background}{name=background, column=0, row=0.25, span=1}{
    \textit{Checksims} was originally created by Matt Heon and Dolan Murvihill
    in 2014 in order to help Professor Lauer find unauthorized copying on his
    assignments. We felt that the algorithms implemented by Matt and Dolan were
    too simple to detect more disguised copying, and wanted to implement
